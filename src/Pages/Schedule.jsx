...
export default function Schedule() {
  ...
  const nextRace = useMemo(() => {
    ...
    return upcomingRaces.sort((a, b) => new Date(a.date) - new Date(b.date))[0];
  }, [upcomingRaces]);
  ...
  return (
    <div className="min-h-screen">
      ...
      <AnimatedSection>
        <h2 className="text-2xl text-gray-600 font-bold px-8">Ended Races</h2>
      </AnimatedSection>
        ...
        {endedRaces.map((race) => {
          ...
          return (
            <motion.div
              ...
              whileHover="hover"
              onClick={() =>
                navigate(`/sessions?year=${year}&round=${race.round_number}`)
              }
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {race.top_three?.map((driver, i) => (
                      ...
                      >
                        ...
                        >
                          <div className="max-h-[100px] lg:max-h-[150px] overflow-hidden rounded-lg mx-auto">
                            <img
                          ...
                          <div
                            className={`absolute -top-3 -left-2 w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 rounded-full flex items-center justify-center font-bold z-10 shadow-lg text-white text-sm md:text-base lg:text-lg
                                                            ${
                                                              driver.position ===
                                                              1
                                                                ? "bg-[#ffd700] "
        ...
        <AnimatedSection>
          ...
          >
            <div className="md:flex-1">
              <p className="text-red-400 font-semibold text-sm uppercase tracking-wider">
                Next Race
              </p>
              ...
              <div className="flex items-center gap-4 md:gap-6 mt-4">
                ...
                <span className="text-3xl md:text-4xl font-bold text-gray-600 mt-[-8px]">
                  :
                </span>
                <div className="text-center">
                  <div className="text-4xl md:text-5xl font-bold text-red-400">
      ...
      {(() => {
        const remainingUpcoming = upcomingRaces.filter(
          (race) => race.round_number !== nextRace?.round_number
        );
